 ...
 * @author junio
 */
public class FrmConsultaClientesOrdenes extends JPanel {
    
    public FrmConsultaClientesOrdenes() {
        initComponents();
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == newButton) {
                FrmConsultaClientesOrdenes.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                FrmConsultaClientesOrdenes.this.deleteButtonActionPerformed(evt);
            }
            else if (evt.getSource() == saveButton) {
                FrmConsultaClientesOrdenes.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                FrmConsultaClientesOrdenes.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteDetailButton) {
                FrmConsultaClientesOrdenes.this.deleteDetailButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newDetailButton) {
                FrmConsultaClientesOrdenes.this.newDetailButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteDetailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteDetailButtonActionPerformed
        ...
        lab004.Customer c = list.get(masterTable.convertRowIndexToModel(index));
        Collection<lab004.PurchaseOrder> ps = c.getPurchaseOrderList();
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<lab004.Customer> toRemove = new ArrayList<lab004.Customer>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            lab004.Customer c = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(c);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        lab004.Customer c = new lab004.Customer();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<lab004.Customer> merged = new ArrayList<lab004.Customer>(list.size());
            for (lab004.Customer c : list) {
    ...
    private java.util.List<lab004.Customer> list;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmConsultaClientesOrdenes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new FrmConsultaClientesOrdenes());
