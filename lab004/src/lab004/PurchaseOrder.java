...
public class PurchaseOrder implements Serializable {
    ...
    public String toString() {
        return "lab004.PurchaseOrder[ orderNum=" + orderNum + " ]";
    }
    ...
    public void setProductId2(Product productId2) {
        Product oldProductId2 = this.productId2;
        this.productId2 = productId2;
        changeSupport.firePropertyChange("productId2", oldProductId2, productId2);
    }
