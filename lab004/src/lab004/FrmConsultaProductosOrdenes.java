 ...
 * @author junio
 */
public class FrmConsultaProductosOrdenes extends JPanel {
    
    public FrmConsultaProductosOrdenes() {
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.beansbinding.ELProperty eLProperty = org.jdesktop.beansbinding.ELProperty.create("${selectedElement.purchaseOrderCollection}");
        ...
        columnBinding.setColumnClass(lab004.Customer.class);
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == newButton) {
                FrmConsultaProductosOrdenes.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                FrmConsultaProductosOrdenes.this.deleteButtonActionPerformed(evt);
            }
            else if (evt.getSource() == saveButton) {
                FrmConsultaProductosOrdenes.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                FrmConsultaProductosOrdenes.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteDetailButton) {
                FrmConsultaProductosOrdenes.this.deleteDetailButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newDetailButton) {
                FrmConsultaProductosOrdenes.this.newDetailButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteDetailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteDetailButtonActionPerformed
        ...
        lab004.Product P = list.get(masterTable.convertRowIndexToModel(index));
        Collection<lab004.PurchaseOrder> ps = P.getPurchaseOrderCollection();
        int[] selected = detailTable.getSelectedRows();
        List<lab004.PurchaseOrder> toRemove = new ArrayList<lab004.PurchaseOrder>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            selected[idx] = detailTable.convertRowIndexToModel(selected[idx]);
            int count = 0;
            Iterator<lab004.PurchaseOrder> iter = ps.iterator();
            while (count++ < selected[idx]) {
                iter.next();
            }
            lab004.PurchaseOrder p = iter.next();
            toRemove.add(p);
    ...
    private void newDetailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newDetailButtonActionPerformed
        ...
        Collection<lab004.PurchaseOrder> ps = P.getPurchaseOrderCollection();
        if (ps == null) {
            ps = new LinkedList<lab004.PurchaseOrder>();
            P.setPurchaseOrderCollection((List) ps);
        }
        lab004.PurchaseOrder p = new lab004.PurchaseOrder();
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<lab004.Product> toRemove = new ArrayList<lab004.Product>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            lab004.Product P = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(P);
            entityManager.remove(P);
        }
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        lab004.Product P = new lab004.Product();
        entityManager.persist(P);
        list.add(P);
        int row = list.size() - 1;
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<lab004.Product> merged = new ArrayList<lab004.Product>(list.size());
            for (lab004.Product P : list) {
    ...
    private java.util.List<lab004.Product> list;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmConsultaProductosOrdenes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new FrmConsultaProductosOrdenes());
