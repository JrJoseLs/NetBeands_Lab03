 ...
 * @author junio
 */
public class FrmMantenimientoClientes extends JPanel {
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                FrmMantenimientoClientes.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                FrmMantenimientoClientes.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                FrmMantenimientoClientes.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                FrmMantenimientoClientes.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<sistemaopensource1.Customer> toRemove = new ArrayList<sistemaopensource1.Customer>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            sistemaopensource1.Customer c = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(c);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        sistemaopensource1.Customer c = new sistemaopensource1.Customer();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<sistemaopensource1.Customer> merged = new ArrayList<sistemaopensource1.Customer>(list.size());
            for (sistemaopensource1.Customer c : list) {
    ...
    private java.util.List<sistemaopensource1.Customer> list;
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new FrmMantenimientoClientes());
    ...
    void setContentPane(FrmMantenimientoClientes frmMantenimientoClientes) {
